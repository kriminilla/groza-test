...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Halo, {{ auth('admin')->user()->name ?? 'Admin' }}!</h1>
            </div>
            <div class="col-sm-6">
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="small-box bg-warning">
            ...
            <a href="{{ route('partnerlist.index') }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
        </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-6">
