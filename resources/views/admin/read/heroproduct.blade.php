...
@section('title', 'GROZA | HERO PRODUCT')
...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>Hero Product per Subkategori</h1>
      </div>
      <div class="col-sm-6">
          ...
          @forelse($subcategories as $sub)
            <div class="col-md-4 mb-4">
              <div class="card h-100">
                <img src="{{ asset($sub->image ?? 'img/no-image.png') }}" class="card-img-top" alt="{{ $sub->nama_subkategori }}">
            ...
            <div class="modal fade" id="modal-edit-{{ $sub->id }}">
              <div class="modal-dialog">
                <div class="modal-content">
                  <form action="{{ route('heroproduct.update', $sub->id) }}" method="POST" enctype="multipart/form-data" class="swal-loading">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="modal-body">
                      ...
                      <div class="text-center">
                        <img src="{{ asset($sub->image ?? 'img/no-image.png') }}" class="img-fluid rounded" alt="{{ $sub->subcategory_name }}">
                      </div>
                    </div>
